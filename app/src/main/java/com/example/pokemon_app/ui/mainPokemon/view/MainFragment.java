package com.example.pokemon_app.ui.mainPokemon.view;
...
import com.example.pokemon_app.databinding.FragmentMainBinding;
import com.example.pokemon_app.ui.detailPokemon.DetailActivity;
import com.example.pokemon_app.ui.mainPokemon.view.adapter.PokemonRecyclerViewListAdapter;
import com.example.pokemon_app.ui.mainPokemon.viewModel.MainViewModel;
...
public class MainFragment extends Fragment implements PokemonRecyclerViewListAdapter.OnItemClickListener {
    ...
    private void fetchPokemonList(int offset) {
        mainViewModel.fetchPokemonList(offset);
    }
    ...
    private void handleOnBackPressed() {
        requireActivity().getOnBackPressedDispatcher().addCallback(new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                mainViewModel.resetValuesLiveData();
    ...
    public void onDestroy() {
        super.onDestroy();
        mainViewModel.getDisposableToUnsubscribe();
    }
}